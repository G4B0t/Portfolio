export const theme = {
  ...
  breakpoints: { tablet: '48rem', laptop: '80rem', desktop: '90rem' }, radii: { sm: '0.375rem', md: '0.75rem', lg: '1.25rem', pill: '999px' }, shadows: { card: '0 18px 48px rgba(0, 0, 0, 0.24)', glowSubtle: '0 0 32px rgba(124, 99, 255, 0.16)', glowAccent: '0 12px 36px rgba(124, 99, 255, 0.28)' }, transitions: { default: '180ms ease', slow: '360ms ease' }, layout: { pageMax: '78rem' },
};
